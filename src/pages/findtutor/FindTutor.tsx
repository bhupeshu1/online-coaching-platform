...
import { tutorData } from '../../utils/mockData';
  ...
  return (
    <div className='w-full h-lvh p-10'>
      ...
      <div className='w-full h-lvh'>
        <h1 className='text-6xl mb-6 font-normal text-[#232323] p-1'>
        ...
        <div className='flex items-center justify-start gap-2'>
          <p className='text-lg font-medium font-sans text-[#191919] cursor-pointer'>
            Excellent
          </p>
